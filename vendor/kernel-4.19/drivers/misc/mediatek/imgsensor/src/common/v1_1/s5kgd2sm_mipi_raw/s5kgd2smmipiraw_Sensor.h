 ...
 * Filename:
 * ---------
 *	 s5kgd2smmipiraw_Sensor.h
 *
 ****************************************************************************/
#ifndef _S5KGD2SMMIPI_SENSOR_H
#define _S5KGD2SMMIPI_SENSOR_H
...
extern int s5kgd2sm_get_otp_data(void);
extern void load_s5kgd2sm_awb(void);
#endif
