...
struct IMGSENSOR_HW_CFG imgsensor_custom_config[] = {
	{
		...
		IMGSENSOR_I2C_DEV_0,
		{
			...
			#if (PUNMUX_GPIO_NONE_FUNC_NONE == __CUST_CAMERA_MAIN_VCAMIO_PMU_WL2864C_SUPPORT__)
		...
		#ifdef CONFIG_LDO_WL2864C
			#if (PUNMUX_GPIO_NONE_FUNC_NONE == __CUST_CAMERA_MAIN_VCAMAF_PMU_WL2864C_SUPPORT__)
	...
	},
	{
		...
		IMGSENSOR_I2C_DEV_1,
		{
			...
			{IMGSENSOR_HW_PIN_AVDD,  IMGSENSOR_HW_ID_GPIO},
		#ifdef CONFIG_LDO_WL2864C
			#if (PUNMUX_GPIO_NONE_FUNC_NONE == __CUST_CAMERA_SUB_VCAMIO_PMU_WL2864C_SUPPORT__)
				{IMGSENSOR_HW_PIN_DOVDD, IMGSENSOR_HW_ID_REGULATOR},
			#else
				{IMGSENSOR_HW_PIN_DOVDD, IMGSENSOR_HW_ID_GPIO},
			#endif
	...
	},
	{
		...
		IMGSENSOR_I2C_DEV_2,
		{
			...
			{IMGSENSOR_HW_PIN_AVDD,  IMGSENSOR_HW_ID_GPIO},
		#ifdef CONFIG_LDO_WL2864C
			#if (PUNMUX_GPIO_NONE_FUNC_NONE == __CUST_CAMERA_MAIN2_VCAMIO_PMU_WL2864C_SUPPORT__)
				{IMGSENSOR_HW_PIN_DOVDD, IMGSENSOR_HW_ID_REGULATOR},
			#else
				{IMGSENSOR_HW_PIN_DOVDD, IMGSENSOR_HW_ID_GPIO},
			#endif
	...
	},
	{
		...
		IMGSENSOR_I2C_DEV_2,
		{
			...
			{IMGSENSOR_HW_PIN_AVDD,  IMGSENSOR_HW_ID_GPIO},
		#ifdef CONFIG_LDO_WL2864C
			#if (PUNMUX_GPIO_NONE_FUNC_NONE == __CUST_CAMERA_SUB2_VCAMIO_PMU_WL2864C_SUPPORT__)
				{IMGSENSOR_HW_PIN_DOVDD, IMGSENSOR_HW_ID_REGULATOR},
			#else
				{IMGSENSOR_HW_PIN_DOVDD, IMGSENSOR_HW_ID_GPIO},
			#endif
