...
static imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5KHM2SP_SENSOR_ID, //Sensor ID Value: 0x30C8//record sensor id defined in Kd_imgsensor.h
	...
	.cap = {
		.pclk = 1600000000, /* record different mode's pclk */
		.linelength = 24064, /* record different mode's linelength */
		.framelength = 9428, /* record different mode's framelength */
		.startx = 0,
		.starty = 0,   /* record different mode's starty of grabwindow */
	...
	.hs_video = {
		.pclk = 1600000000,	/* record different mode's pclk */
		.linelength = 5552, /* record different mode's linelength */
	...
	.i2c_speed = 400,
	.i2c_addr_table = {0xAC, 0x7A, 0x20, 0x5A, 0xff}, //record sensor support all write id addr, only supprt 4must end with 0xff
};
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
	...
	{12000, 9000, 0,   0,    12000, 9000, 12000, 9000, 0, 0, 12000, 9000, 0, 0, 12000, 9000}, /* capture */
	{12000, 9000, 0,   0,    12000, 9000, 4000,  3000, 0, 0, 4000,  3000, 0, 0, 4000,  3000}, /* video */
	{12000, 9000, 240, 1260, 11520, 6480, 1920,  1080, 0, 0, 1920,  1080, 0, 0, 1920,  1080}, /* high speed video */
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff)
	{
		...
		do
		{
			*sensor_id = return_sensor_id();
			...
			{
				up_otp_state_mainhm2=s5khm2sp_get_otp_data();
