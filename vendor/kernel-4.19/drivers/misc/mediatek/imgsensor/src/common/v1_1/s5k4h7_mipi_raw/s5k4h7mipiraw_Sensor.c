...
extern int update_4h7_otp(void);
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
 ...
 { 3264, 2448,  352, 264, 2560, 1920,  640,   480, 0000, 0000,  640,  480,     0,  0,  640,  480}, /* high speed video */
...
static void sensor_init(void)
{
	...
	/* Base on S5K4H7_EVT0_Reference_setfile_v1.20 */
...
static kal_uint32 streaming_control(kal_bool enable)
{
	...
	LOG_INF("[%s] +", __func__);
	if (enable) {
		LOG_INF("set stream on\n");
		write_cmos_sensor_8(0x0100, 0x01);
	} else {
		LOG_INF("set stream off\n");
		write_cmos_sensor_8(0x0100, 0x00);
		check_stream_is_off();
	}
	return ERROR_NONE;
