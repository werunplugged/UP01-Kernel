...
static struct imgsensor_struct imgsensor = {
	...
	.current_fps = 300,	/* full size current fps :
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {
	...
	{5344, 4016, 0, 568, 5344, 2880, 1336, 720,
	 28, 0000, 1280, 720, 0, 0, 1280, 720},
...
static void set_shutter(kal_uint32 shutter)
{
	...
	/* larger than frame exposure. AE doesn't update sensor gain at */
	/* capture mode, thus extra exposure lines must be updated here. */
...
{
	imx338_table_write_cmos_sensor(
		addr_data_pair_hs_video_imx338,
			   ...
			   MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	sensor_info->SensorClockFallingPolarity =
		SENSOR_CLOCK_POLARITY_LOW;	/* Not used */
...
/*LOG_INF("feature_id = %d\n", feature_id);*/
	...
	case SENSOR_FEATURE_GET_CROP_INFO:
		...
		case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
			memcpy(
			    (void *)wininfo, (void *)&imgsensor_winsize_info[1],
			     sizeof(struct SENSOR_WINSIZE_INFO_STRUCT));
			break;
		case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
			memcpy(
			    (void *)wininfo, (void *)&imgsensor_winsize_info[2],
			     sizeof(struct SENSOR_WINSIZE_INFO_STRUCT));
			break;
		case MSDK_SCENARIO_ID_HIGH_SPEED_VIDEO:
			memcpy(
			    (void *)wininfo, (void *)&imgsensor_winsize_info[3],
			     sizeof(struct SENSOR_WINSIZE_INFO_STRUCT));
			break;
		case MSDK_SCENARIO_ID_SLIM_VIDEO:
			memcpy(
			    (void *)wininfo, (void *)&imgsensor_winsize_info[4],
			      sizeof(struct SENSOR_WINSIZE_INFO_STRUCT));
			break;
		case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
		default:
			memcpy(
			    (void *)wininfo, (void *)&imgsensor_winsize_info[0],
			     sizeof(struct SENSOR_WINSIZE_INFO_STRUCT));
			break;
		}
		break;
