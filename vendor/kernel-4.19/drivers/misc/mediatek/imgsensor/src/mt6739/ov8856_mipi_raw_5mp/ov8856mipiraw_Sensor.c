...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
	...
	{3296, 2480, 0, 12, 3296, 2456, 1648, 1228,
		2,	2, 1632, 1224, 0, 0, 1280, 960},
	/* capture */
	{3296, 2480, 0, 12, 3296, 2456, 3296, 2456,
		4,	2, 3264, 2448, 0, 0, 2560, 1920},
	/* video*/
	{3296, 2480, 0, 12, 3296, 2456, 3296, 2456,
		4,	2, 3264, 2448, 0, 0, 2560, 1920},
	/*hight speed video */
...
static kal_uint16 ov8856_table_write_cmos_sensor(kal_uint16 *para,
	kal_uint32 len)
{
		...
		do {
			*sensor_id = ((read_cmos_sensor(0x300B) << 8)
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
				pr_debug("i2c write id: 0x%x, sensor id: 0x%x, ver = 0x%x<0xB1=r2a,0xB0=r1a>\n",
...
/*const kal_uint8 i2c_addr[] = {IMGSENSOR_WRITE_ID_1, IMGSENSOR_WRITE_ID_2};*/
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			...
			pr_debug("Read sensor id fail, write: 0x%x, sensor: 0x%x\n",
				imgsensor.i2c_write_id, sensor_id);
			retry--;
		} while (retry > 0);
		i++;
