...
#define AW8601xAF_DRIVER_VERSION	"v0.3.0"
...
long AW8601AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
...
int AW8601AF_Release(struct inode *a_pInode, struct file *a_pstFile)
{
	int ret = 0;
...
int AW8601AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient,
...
int AW8601AF_GetFileName(uint8_t *pFileName)
{
