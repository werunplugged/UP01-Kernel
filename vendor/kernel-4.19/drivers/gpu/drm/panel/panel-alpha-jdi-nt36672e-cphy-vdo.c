...
static void jdi_panel_init(struct jdi *ctx)
{
	...
	jdi_dcs_write_seq_static(ctx, 0XC1, 0X89,0X28,0X00,0X08,0X00,0XAA,0X02,0X0E,0X00,0X2B,0X00,
	...
	jdi_dcs_write_seq_static(ctx, 0XFF, 0X20);
	jdi_dcs_write_seq_static(ctx, 0XFB, 0X01);
	jdi_dcs_write_seq_static(ctx, 0XB0, 0x00,0x00,0x00,0x1F,0x00,0x49,0x00,0x6B,0x00,0x85,0x00,
				0x9C,0x00,0xB1,0x00,0xC4);
	jdi_dcs_write_seq_static(ctx, 0XB1, 0x00,0xD1,0x01,0x07,0x01,0x30,0x01,0x6E,0x01,0x9E,0x01,
				0xE5,0x02,0x1E,0x02,0x1F);
	jdi_dcs_write_seq_static(ctx, 0XB2, 0x02,0x56,0x02,0x96,0x02,0xBF,0x02,0xF4,0x03,0x16,0x03,
				0x41,0x03,0x51,0x03,0x5F);
	jdi_dcs_write_seq_static(ctx, 0XB3, 0x03,0x6E,0x03,0x82,0x03,0x98,0x03,0xAC,0x03,0xCC,0x03,
				0xD8,0x00,0x00);
	jdi_dcs_write_seq_static(ctx, 0XB4, 0x00,0x00,0x00,0x1E,0x00,0x49,0x00,0x69,0x00,0x84,0x00,
				0x9B,0x00,0xAF,0x00,0xC1);
	jdi_dcs_write_seq_static(ctx, 0XB5, 0x00,0xD2,0x01,0x07,0x01,0x30,0x01,0x6E,0x01,0x9D,0x01,
				0xE5,0x02,0x1F,0x02,0x20);
	jdi_dcs_write_seq_static(ctx, 0XB6, 0x02,0x57,0x02,0x96,0x02,0xBF,0x02,0xF3,0x03,0x16,0x03,
				0x3F,0x03,0x4F,0x03,0x5D);
	jdi_dcs_write_seq_static(ctx, 0XB7, 0x03,0x6D,0x03,0x81,0x03,0x98,0x03,0xAC,0x03,0xCC,0x03,
				0xD8,0x00,0x00);
	jdi_dcs_write_seq_static(ctx, 0XB8, 0x00,0x00,0x00,0x20,0x00,0x48,0x00,0x6A,0x00,0x86,0x00,
				0x9F,0x00,0xB5,0x00,0xC6);
	jdi_dcs_write_seq_static(ctx, 0XB9, 0x00,0xD8,0x01,0x0D,0x01,0x36,0x01,0x73,0x01,0xA1,0x01,
				0xE8,0x02,0x21,0x02,0x22);
	jdi_dcs_write_seq_static(ctx, 0XBA, 0x02,0x58,0x02,0x98,0x02,0xC1,0x02,0xF7,0x03,0x1B,0x03,
				0x41,0x03,0x54,0x03,0x66);
	jdi_dcs_write_seq_static(ctx, 0XBB, 0x03,0x6E,0x03,0x82,0x03,0x98,0x03,0xAC,0x03,0xD0,0x03,
				0xD8,0x00,0x00);
